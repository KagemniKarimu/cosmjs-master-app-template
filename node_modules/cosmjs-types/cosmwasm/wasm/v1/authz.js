...
exports.ContractExecutionAuthorization = {
    ...
    fromJSON(object) {
        return {
            grants: Array.isArray(object?.grants) ? object.grants.map((e) => exports.ContractGrant.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.ContractGrant = {
    ...
    fromJSON(object) {
        return {
            ...
            limit: (0, helpers_1.isSet)(object.limit) ? any_1.Any.fromJSON(object.limit) : undefined,
            filter: (0, helpers_1.isSet)(object.filter) ? any_1.Any.fromJSON(object.filter) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.MaxCallsLimit = {
    ...
    fromJSON(object) {
        return {
            remaining: (0, helpers_1.isSet)(object.remaining) ? helpers_1.Long.fromValue(object.remaining) : helpers_1.Long.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        message.remaining !== undefined && (obj.remaining = (message.remaining || helpers_1.Long.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMaxCallsLimit();
...
exports.CombinedLimit = {
    ...
    fromJSON(object) {
        return {
            callsRemaining: (0, helpers_1.isSet)(object.callsRemaining) ? helpers_1.Long.fromValue(object.callsRemaining) : helpers_1.Long.UZERO,
            amounts: Array.isArray(object?.amounts) ? object.amounts.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        ...
        message.callsRemaining !== undefined &&
            (obj.callsRemaining = (message.callsRemaining || helpers_1.Long.UZERO).toString());
        if (message.amounts) {
            obj.amounts = message.amounts.map((e) => (e ? coin_1.Coin.toJSON(e) : undefined));
        }
        else {
...
exports.AcceptedMessagesFilter = {
    ...
    fromJSON(object) {
        return {
            messages: Array.isArray(object?.messages) ? object.messages.map((e) => (0, helpers_1.bytesFromBase64)(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
