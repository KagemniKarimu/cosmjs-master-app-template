...
exports.Sequence = {
    ...
    fromJSON(object) {
        return {
            ...
            value: (0, helpers_1.isSet)(object.value) ? helpers_1.Long.fromValue(object.value) : helpers_1.Long.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.value !== undefined && (obj.value = (message.value || helpers_1.Long.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseSequence();
