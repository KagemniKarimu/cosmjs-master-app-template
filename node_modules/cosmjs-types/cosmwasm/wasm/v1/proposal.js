    ...
    fromJSON(object) {
        return {
            ...
            instantiatePermission: (0, helpers_1.isSet)(object.instantiatePermission)
                ...
                : undefined,
            unpinCode: (0, helpers_1.isSet)(object.unpinCode) ? Boolean(object.unpinCode) : false,
            source: (0, helpers_1.isSet)(object.source) ? String(object.source) : "",
            builder: (0, helpers_1.isSet)(object.builder) ? String(object.builder) : "",
...
exports.PinCodesProposal = {
    ...
    fromJSON(object) {
        return {
            title: (0, helpers_1.isSet)(object.title) ? String(object.title) : "",
            description: (0, helpers_1.isSet)(object.description) ? String(object.description) : "",
            codeIds: Array.isArray(object?.codeIds) ? object.codeIds.map((e) => helpers_1.Long.fromValue(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.title = object.title ?? "";
        message.description = object.description ?? "";
        message.codeIds = object.codeIds?.map((e) => helpers_1.Long.fromValue(e)) || [];
        return message;
    },
};
